...
void ticker_handler()
{
    ...
    else
    {
        ...
        float Temperature = 18.02;
        float Humidity    = 95.00;
        String send_buffer {R"rawliteral({"reported": {"Temper":)rawliteral" + String{Temperature} +R"rawliteral(,"Humi":)rawliteral" + String(Humidity) + R"rawliteral(}})rawliteral"};
